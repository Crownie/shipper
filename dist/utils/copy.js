...
function copyFolderRecursive(source, target) {
  return __awaiter(this, void 0, void 0, function() {
    var files_1, files, targetFolder;
    var _this = this;
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          if (exports.isGlob(source)) {
            files_1 = glob.sync(source, {});
            return [
              2 /*return*/,
              Promise.all(
                files_1.map(function(src) {
                  return copyFolderRecursive(src, target);
                }),
              ),
            ];
          }
          files = [];
          targetFolder = path_1.default.join(
            target,
            ...
            Promise.all(
              files.map(function(file) {
                return __awaiter(_this, void 0, void 0, function() {
                  var curSource;
                  return __generator(this, function(_a) {
                    curSource = path_1.default.join(source, file);
